...
async function main() {
  ...
  try {
    ...
    console.log(`Demo roster ready: ${result.roster.students.length} students, ${result.events.length} XP requests checked, Weekend Story and Conversation Starters content ready.`);
