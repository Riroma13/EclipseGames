...
const studentPatch = studentDraftSchema.omit({ avatar: true }).partial().refine((value) => Object.keys(value).length > 0, 'At least one field is required.');
