...
import type { BehaviourSessionStartPort } from './service.js';
...
export function registerCalendarRoutes(app:FastifyInstance,db:Database.Database,behaviour?:BehaviourSessionStartPort){const session=requireSession(db);
